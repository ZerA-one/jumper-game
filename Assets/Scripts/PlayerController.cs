...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField] private AudioSource m_DashSoundEffect;
	...
	private void OnTriggerEnter2D(Collider2D collision)
	{
        ...
        {
            playerInventory.OnPickupItem(collision.gameObject.GetComponent<Item>());
        }
		if (collision.gameObject.tag == "Finish")
		{
			print("finish");
			collision.gameObject.GetComponent<GoldenSkull>().OnPickupAndChangeScene();
		}
	}
